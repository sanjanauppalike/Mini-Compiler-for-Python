...
Stmt: Simple_stmt | Compound_stmt | Assignment_stmt ;
...
| Exp {};
If_stmt: IF LPAREN Exp RPAREN COLON INDENT Stmt Elif_stmt Else_stmt ;
Elif_stmt: ELIF LPAREN Exp RPAREN COLON INDENT Stmt Elif_stmt Else_stmt | ;
Else_stmt: ELSE COLON INDENT Stmt | ;
